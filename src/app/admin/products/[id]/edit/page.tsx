    ...
    async function loadData() {
      ...
      try {
        ...
        if (prodData) {
          ...
          setCategoryName(prodData.category || "");
          setPrice(String(prodData.price || ""));
          setDiscountPrice(prodData.discount_price ? String(prodData.discount_price) : "");
        ...
        const msg = err instanceof Error ? err.message : "Failed to load product details from database.";
        setErrorMsg(msg);
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: Record<string, unknown> = {
        ...
        discount_price: discountPrice && parseFloat(discountPrice) > 0 ? parseFloat(discountPrice) : null,
      ...
      const msg = postgrestErr?.message || (err instanceof Error ? err.message : "Failed to update product.");
      setErrorMsg(msg);
      setSaveLoading(false);
    }
  };
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Update inventory specifications and real-time pricing
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-5 bg-slate-900 border border-slate-800 p-5 sm:p-6 rounded-2xl">
            ...
            <div>
              ...
              <input
                ...
                placeholder="256GB • 8GB RAM • 50MP OIS"
                className="w-full px-4 py-2.5 bg-slate-950/80 border border-slate-700 focus:border-brand-primary rounded-xl text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none"
              />
            </div>
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              />
              <label htmlFor="edit-featured" className="text-xs text-slate-300 cursor-pointer">
            ...
            <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-950/80 border border-slate-700 focus:border-brand-primary rounded-xl text-xs sm:text-sm text-white font-bold focus:outline-none"
                />
              </div>
